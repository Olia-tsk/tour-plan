            ...
            <div class="footer-wrapper">
                ...
                <div class="footer__social-network">
                    ...
                    <div class="footer__social-links">
                        ...
                        <a href="#" class="footer__link">
                            <img src="img/icon-youtube.svg" alt="icon: youtube">
                        </a>
                        <a href="#" class="footer__link">
                ...
                <div class="footer__contact-details">
                    <h3 class="footer__title footer__title--margin">Contact Details</h3>
                    ...
                    <ul class="footer__ul">
                        <li class="footer__item footer__item--margin">
                            <div class="footer__icon-wrapper">
                                <img src="img/footer-icon-map-pin.svg" alt="icon: map pin" class="footer__icon">
                            </div>
            ...
            <div class="footer-service">
                <ul class="footer-service__list">
                    <li class="footer-service__item">
                        <a href="#" class="footer-service__link">Disclaimer</a>
                    </li>
                    <li class="footer-service__item">
                        <a href="#" class="footer-service__link">Conditions of use</a>
                    </li>
                    <li class="footer-service__item">
                        <a href="#" class="footer-service__link">Cancellation policy</a>
                    </li>
                </ul>
                <img src="img/payment.jpg" alt="icon: pay cards" class="footer__payment">
            </div>
        </div>
    </footer>
